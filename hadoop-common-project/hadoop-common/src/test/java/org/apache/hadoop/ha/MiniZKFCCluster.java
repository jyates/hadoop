...
public class MiniZKFCCluster {
  ...
  /**
   * Set up two services and their failover controllers. svc1 is started first, so that it enters
   * ACTIVE state, and then svc2...svcN is started, which enters STANDBY.
   * <p>
